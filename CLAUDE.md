...
- **The service worker caches only the data pages** (`/`, `/spread`, `/collation/*`), network first, and the cache is cleared on logout. Don't add pages that show agent phone numbers to it.
